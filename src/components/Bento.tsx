...
const Bento = () => {
    ...
    return (
        <div className='flex h-[130vh] w-full bg-[#1E1E1E] text-white justify-center items-center p-10'>
            <div className='grid h-full w-full grid-cols-3 grid-rows-6 gap-4'>
                ...
                <div className='bg-[#0E0E10]/30 rounded-xl row-span-4 col-span-2'>
                    <div
                ...
                <div className='bg-[#0E0E10]/30 rounded-xl row-span-2 p-1'>
                    ...
                    <div className='p-4 flex items-center justify-center w-full flex-col'>
                        <p className='font-extrabold text-2xl mb-2'>Contact Me</p>
